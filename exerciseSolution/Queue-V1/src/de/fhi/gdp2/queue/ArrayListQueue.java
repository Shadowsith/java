...
// A queue implementation by generic type ArrayList.
// We inherit from ArrayList in order to show
// combination of 'extends' and 'implements'
@SuppressWarnings("serial")
public class ArrayListQueue extends ArrayList<Integer> implements Queue {
    // -----------------------------------------
    ...
    public boolean isFull() {
        // An ArrayList is never full as long as there is memory
        return false;
    }
