...
import de.fhi.gdp2.queue.LinkedListQueue;
import de.fhi.gdp2.queue.Queue;

public class UTestLinkedListQueue {
    @Test
    public void test_DemoTheQueue_00() throws Exception {
        ...
        q.enqueue(6);
        q.showQueue(mute);
        assertEquals("Wrong head value from queue", 9, (int) q.dequeue());
        assertEquals("Wrong head value from queue", 15, (int) q.dequeue());
        assertEquals("Wrong head value from queue", 6, (int) q.dequeue());
    ...
    public void test_enqueue_01() throws Exception {
        ...
        // LinkedList has no internal length.
        int startSize = 2;
        int count = 0;
