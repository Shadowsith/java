...
import de.fhi.gdp2.queue.SimpleArrayQueue;

@SuppressWarnings("unused")
public class UTestSimpleArrayQueue {
    @Test
    public void test_DemoTheQueue_00() throws Exception {
        Queue<Integer> q = new SimpleArrayQueue<Integer>();
        boolean mute = true;
    ...
    public void test_enqueue_01() throws Exception {
        ...
        Queue<Integer> q = new SimpleArrayQueue<Integer>(logManager);
        //Queue<Integer> q = new SimpleArrayQueue<Integer>();
        boolean mute = true;
